...
import PhotopeaWindow from '@/components/windows/Photopea';
import FrameWindow from '@/components/windows/Frame';
import XpraWindow from '@/components/windows/xpra';
...
Vue.component('XpraWindow',XpraWindow);
Vue.component('PlexWindow',PlexWindow);
Vue.component('PhotopeaWindow',PhotopeaWindow);
